...
- (void)test:(id)sender
{
    ...
    [[alert window] setTitle:[NSString stringWithUTF8String:"Application"]];
    [alert setAlertStyle:2];
    [alert setMessageText:[NSString stringWithUTF8String:"Problem"]];
    [alert setInformativeText:[NSString stringWithUTF8String:"Unable to connect to debugger"]];
    [alert runModal];
}
@end
